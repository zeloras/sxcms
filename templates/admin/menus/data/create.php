...
<div class="widget-header">
    ...
    <span class="action_buttons">
        <button class="btn pull-right formSubmit" data-form="#submit-form" data-after="exit" data-action="/admin/menus_data/add/<?=$menu_id?>">
            <i class=" icon-save icon-large"></i> <?=__('Save and exit')?>
        </button>
        <button class="btn btn-success pull-right formSubmit" data-form="#submit-form" data-after="save" data-action="/admin/menus_data/add/<?=$menu_id?>">
...
<div class="widget-content">
    <?if (isset($success)) {?>
        <div id="success_block">
            ...
            <p id="url_success">/admin/menus_data/edit/<?=$menu_id?>/<?=$success?></p>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane active" id="content">
                ...
                <div class="control-group sx_menu_block_type">
                    ...
                    <div class="controls">
                        <select class="input-xxlarge sx_menu_type" name="linktype" id="linktype_p" 
                                data-first=".sx_menu_block_first"
                                data-second=".sx_menu_block_second"
                                data-threed=".sx_menu_block_threed">
                            <option value="1"><?=__("Category")?></option>
                            <option value="2"><?=__("Page")?></option>
                            <option value="3"><?=__("System")?></option>
                            <option value="4"><?=__("Link")?></option>
                        </select>
                    </div>
                </div>
                
                <div class="control-group sx_menu_block_first">
                    <label class="control-label" for="first_p"><?=__('Category')?></label>
                    <div class="controls">
                        <select class="input-xxlarge sx_menu_first" name="first" id="first_p" 
                                data-second=".sx_menu_block_second"
                                data-first=".sx_menu_block_first"
                                data-type=".sx_menu_block_type">
                ...
                <div class="control-group sx_menu_block_second hide">
                ...
                <div class="control-group sx_menu_block_threed hide">
                    <label class="control-label" for="threed_p"><?=__('Page')?></label>
                    <div class="controls">
                        <input type="text" class="input-xxlarge" name="threed" id="threed_p">
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <div class="input-prepend">
                            <span class="add-on"><i id="icon-block" class=""></i></span>
                            <input type="text" class="input-xxlarge" name="icons" id="icon_p">
                        </div>
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" class="input-xlarge" name="classes" id="classes_p">
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <p><input type="radio" name="visible" checked="checked" class="radio">&nbsp;<?=__('Yes')?>&nbsp;&nbsp;&nbsp;
                        <input type="radio" name="visible" class="radion">&nbsp;<?=__('No')?></p>
                    </div>
                </div>
            </div>
        </div>	

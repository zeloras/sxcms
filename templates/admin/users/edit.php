            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="private_user">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" value="<?=$user['country']?>" class="input-xxlarge" name="country" id="country_p">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="city_p"><?=__('User city')?></label>
                        <div class="controls">
                            <input type="text" value="<?=$user['city']?>" class="input-xxlarge" name="city" id="city_p">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="address_p"><?=__('User address')?></label>
                        <div class="controls">
                            <input type="text" value="<?=$user['address']?>" class="input-xxlarge" name="address" id="address_p">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="zipcode_p"><?=__('User zip code')?></label>
                        <div class="controls">
                            <input type="text" value="<?=$user['zip_code']?>" class="input-xxlarge" name="zipcode" id="zipcode_p">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="phone_p"><?=__('User phone')?></label>
                        <div class="controls">
                            <input type="text" value="<?=$user['phone']?>" class="input-xxlarge" name="phone" id="phone_p">
                        </div>
                    </div>
                </div>
            </div>	

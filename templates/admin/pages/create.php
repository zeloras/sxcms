...
<div class="widget-header">
    <i class="icon-file"></i>
    <h3><?=__('Pages create')?></h3>
    <span class="action_buttons">
        <button class="btn pull-right formSubmit" data-form="#submit-form" data-after="exit" data-action="/admin/pages/add">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="content">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <textarea name="text_prev" class="input-xxlarge load_texteditor" id="text_prev_p"></textarea>
                        </div>
                    </div>
                ...
                <div class="tab-pane" id="settings">
                    <div class="control-group">
                        ...
                        <div class="controls input-append">
                            <input type="text" name="post_time" class="input sx_timepicker" id="post_time_p" style="margin-left: -159px;">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select name="publication_status" class="input-xxlarge" id="publication_status_p">
                                ...
                                <option value="2"><?=__('Peding')?></option>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="template" class="input-xxlarge" id="template_p">
                    ...
                    <!--<div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="site_template" class="input-xxlarge" id="site_template_p">

...
<div class="widget-header">
    ...
    <span class="action_buttons">
        <button class="btn pull-right formSubmit" data-form="#submit-form" data-after="exit" data-action="/admin/categorys/add">
            <i class=" icon-save icon-large"></i> <?=__('Save and exit')?>
        </button>
        <button class="btn btn-success pull-right formSubmit" data-form="#submit-form" data-after="save" data-action="/admin/categorys/add">
...
<div class="widget-content">
    <?if (isset($success)) {?>
        <div id="success_block">
            <p id="status_success">showMessage('<?=__('Success create category')?>', '<?=__('Status category create')?>', 'success')</p>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="content">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" class="input-xxlarge" name="url" id="url_p">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <textarea name="text_full" class="input-xxlarge load_texteditor" id="text_full_p"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" class="input-xxlarge" name="template" id="template_p">
                            <p class="help-block"><?=__('Example: category_spec')?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="tab-pane" id="settings">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <textarea name="meta_keywords" class="input-xxlarge" id="meta_keywords_p"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <textarea name="meta_description" class="input-xxlarge" id="meta_description_p"></textarea>
                        </div>
                    </div>
                </div>
            </div>	

...
<div class="widget-header">
    <i class="icon-file"></i>
    <h3><?=__('Widgets create')?></h3>
    <span class="action_buttons">
        <button class="btn pull-right formSubmit" data-form="#submit-form" data-after="exit" data-action="/admin/widgets/add">
            <i class=" icon-save icon-large"></i> <?=__('Save and exit')?>
        </button>
        <button class="btn btn-success pull-right formSubmit" data-form="#submit-form" data-after="save" data-action="/admin/widgets/add">
...
<div class="widget-content">
    <?if (isset($success)) {?>
        <div id="success_block">
            <p id="status_success">showMessage('<?=__('Success create widget')?>', '<?=__('Status widget create')?>', 'success')</p>
    ...
    <form id="submit-form" method="post" class="form-horizontal">
        <input type="hidden" name="submit_this_form" value="1">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <select class="input-xxlarge sx_change_widget_type" name="type" data-html="#data_block" data-module="#module_block" id="type_p">
                        <option value="html"><?=__('Html widget')?></option>
            ...
            <div class="control-group" id="data_block">
                ...
                <div class="controls">
                    <textarea name="data" class="input-xxlarge load_texteditor" id="data_p"></textarea>
                </div>
            </div>
